...
CLASS ZCL_ACE_PARSER IMPLEMENTATION.
  ...
  method PARSE_TOKENS.
    ...
    " params: CLASS/INTERFACE/ENDCLASS/ENDINTERFACE/METHODS/CLASS-METHODS/FORM
    ...
    DO lv_max TIMES.
      ...
      " lo_params обрабатывает CLASS/INTERFACE/ENDCLASS/ENDINTERFACE/METHODS/CLASS-METHODS/FORM
