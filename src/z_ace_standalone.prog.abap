        ...
        WHILE statement <= str-stmnt_to.
          ...
          IF sy-subrc <> 0.
            ...
            IF i_evtype IS INITIAL.
              <step>-eventtype = 'EVENT'. <step>-eventname = event.
            ELSE.
              <step>-eventtype = i_evtype. <step>-eventname = i_evname.
            ENDIF.
    ...
    METHOD parse_call_form.
      ...
      LOOP AT <kw_tab> INTO kw FROM lv_tabix.
        ...
        IF kw-name = 'FORM' OR kw-name = 'DATA' OR kw-name = 'TYPES'
          OR kw-name = 'CONSTANTS' OR kw-name IS INITIAL. CONTINUE.
        ENDIF.
...
*        OR lv_eff_kw = 'CONSTANTS' .
  ...
  CLASS zcl_ace_metrics_window IMPLEMENTATION.
    METHOD show.
      ...
      SORT lt_events BY cc DESCENDING.
      ...
      SORT lt_forms BY cc DESCENDING.
      ...
      LOOP AT lt_pairs INTO ls_pair.
        ...
        WHILE lv_i <= lv_end_i.
          ...
          CASE <ln>-cond.
            WHEN 'IF' OR 'CASE'.
              IF lv_i = lv_if_i.
                ls_hdr-tabix = lv_i. ls_hdr-cond = <ln>-cond. APPEND ls_hdr TO lt_hdrs.
              ELSE.
                lv_inner_depth += 1.
              ENDIF.
            WHEN 'ENDIF' OR 'ENDCASE'.
        ...
        WHILE lv_h < lv_hdr_cnt.
          ...
          IF sy-subrc = 0.
            IF lv_branch_active = abap_true.
              <hdr_ln>-active_root = abap_true. lv_block_active = abap_true.
            ELSE.
